...
from app.routers import auth, categories, friends, health, livekit, match, onboarding, payments, profiles, public, rooms, verify
...
for module in (health, auth, onboarding, verify, match, rooms, public, livekit, categories, payments, profiles, friends):
