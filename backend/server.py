...
from app.routers import auth, categories, clips, friends, health, livekit, match, notifications, onboarding, payments, private, profiles, public, reports, rooms, verify
...
for module in (health, auth, onboarding, verify, match, rooms, public, livekit, categories, payments, profiles, friends, private, clips, reports, notifications):
