...
from app.routers import auth, categories, health, livekit, match, onboarding, payments, public, rooms, verify
...
for module in (health, auth, onboarding, verify, match, rooms, public, livekit, categories, payments):
